...
public abstract class HttpFileGetHandler extends HttpBinaryHandler implements HttpFileOperator {
	...
	public HttpFileGetHandler(final String route, final String folder) {
		this(route, null, null, folder, FilenameValidator.makeAllFilesValidator());
	}
	
	public HttpFileGetHandler(final String route, final Treater<byte[]> readingAdapter, final Treater<byte[]> writingAdapter, final String folder) {
		this(route, readingAdapter, writingAdapter, folder, FilenameValidator.makeAllFilesValidator());
	}
	
	public HttpFileGetHandler(final String route, final String folder, final String filter) {
		this(route, null, null, folder, filter);
	}
	
	public HttpFileGetHandler(final String route, final Treater<byte[]> readingAdapter, final Treater<byte[]> writingAdapter, final String folder, final String filter) {
		this(route, readingAdapter, writingAdapter, folder, new FilenameValidator(filter));
	}
	
	public HttpFileGetHandler(final String route, final String folder, final FilenameValidator filter) {
		this(route, null, null, folder, filter);
	}
	
	public HttpFileGetHandler(final String route, final Treater<byte[]> readingAdapter, final Treater<byte[]> writingAdapter, final String folder, final FilenameValidator filter) {
